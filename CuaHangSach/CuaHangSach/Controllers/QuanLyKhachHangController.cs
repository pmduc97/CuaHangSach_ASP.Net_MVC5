...
namespace CuaHangSach.Controllers
{
    public class QuanLyKhachHangController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKhachHang,TenKhachHang,MatKhau,NgaySinh,GioiTinh,SoDienThoai,Email,QueQuan")] KHACHHANG kHACHHANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKhachHang,TenKhachHang,MatKhau,NgaySinh,GioiTinh,SoDienThoai,Email,QueQuan")] KHACHHANG kHACHHANG)
        {
            if (ModelState.IsValid)
            {
